...
function theClosestToTargetSum(numArr, targetSum) {
...
console.log(theClosestToTargetSum(arr1, target1));
console.log(theClosestToTargetSum(arr2, target2));
console.log(theClosestToTargetSum(arr3, target3));
console.log(theClosestToTargetSum(arr4, target4));