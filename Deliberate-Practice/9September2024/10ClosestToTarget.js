...
function findClosestPairToTotal(numArr, targetSum) {
...
console.log(findClosestPairToTotal(arr1, target1));
console.log(findClosestPairToTotal(arr2, target2));
console.log(findClosestPairToTotal(arr3, target3));
console.log(findClosestPairToTotal(arr4, target4));
